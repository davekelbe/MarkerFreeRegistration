function [ match_R, match_t ] = kelbe_analysis_noise_fun( aux )
...
filepath_anal_noise_step = sprintf('%sanal_noise_step.mat', path_mat);
if exist(filepath_anal_noise_step, 'file');
    return
end
...
filepath_anal_noise_step = sprintf('%sanal_noise_step.mat', path_mat);
filepath_anal_noise_RMSE = sprintf('%sanal_noise_RMSE.mat', path_mat);
save(filepath_anal_noise_step, 'step_std');
save(filepath_anal_noise_RMSE, 'match_RMSE');
