function [ match_R, match_t ] = kelbe_registration_combine_dis3fun_analyses( aux )
%   This is identical to lines 1-1275 of kelbe_registration_dis3fun
match_R = [];
match_t = [];

info_analysis = aux.info_analysis;
P_LCS = aux.P_LCS;
%P_color = aux.P_color; 
%P_plot = aux.P_plot; 
P_rad = aux.P_rad; 
...
for t = 1:n_M(i,j);
    ...
    for i = 1:n_S;
        for j = i+1:n_S;
            ...
            if isempty(I1J2andI2J1) || isempty(I2J3andI3J2);
