...
for i = 1:n_1
    ...
    lw_1 = min( data_1( data_1( :, i ) > lt_1( i ), i ) );
    uw_1 = max( data_1( data_1( :, i ) < ut_1( i ), i ) );
    
    
    idxl = find( data_1( :, i ) < lt_1( i ) );
    idxu = find( data_1( :, i ) > ut_1( i ) );
    ol_1 = data_1( [ idxl, idxu ], i );
    ...
    lw_2 = min( data_2( data_2( :, i ) > lt_2( i ), i ) );
    uw_2 = max( data_2( data_2( :, i ) < ut_2( i ), i ) );
    
    
    idxl = find( data_2( :, i ) < lt_2( i ) );
    idxu = find( data_2( :, i ) > ut_2( i ) );
    ol_2 = data_2( [ idxl, idxu ], i );
    ...
    lw_3 = min( data_3( data_3( :, i ) > lt_3( i ), i ) );
    uw_3 = max( data_3( data_3( :, i ) < ut_3( i ), i ) );
    
    
    idxl = find( data_3( :, i ) < lt_3( i ) );
    idxu = find( data_3( :, i ) > ut_3( i ) );
    ol_3 = data_3( [ idxl, idxu ], i );
