...
if isfield(d, 'face');
    ...
    if isfield(d.face,'vertex_index')
        vi = d.face.vertex_index; % was vertex_indices 
    else 
        vi = d.face.vertex_indices; % was vertex_indices 
    end
nf = length(vi);
face = zeros(nf,3);
for i=1:nf
...
vertex = [d.vertex.x, d.vertex.y, d.vertex.z, d.vertex.red, d.vertex.green, d.vertex.blue];
