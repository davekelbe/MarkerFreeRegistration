function [  ] = lidar( info_site, info_plot, info_terminate, info_exp )
...
if true
    filepath_ply_dem = sprintf('%sply_dem_%03.0f-%02.0f.ply',path_ply,info_site,info_plot);
...
filepath_I12ieq_outline = sprintf('%sI12ieq_outline_%03.0f-%02.0f.png',path_png,info_site,info_plot);
...
filepath_tree_final = sprintf('%stree_final_%03.0f-%02.0f.png',path_png,info_site,info_plot);
