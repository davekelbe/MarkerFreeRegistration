function [ ] = fig_dbh_neon_xy( site_all, plot_all, match_all )
...
for i = 1:n_site_all;
    ...
    plot(match_all{i}.NEON_neon_xy,percent_error,'x','markersize',10,'linewidth',2,'markeredgecolor',color(i,:));
end

xmax = 2*max(xmax(:));

title('DBH Percent Error ');
legend(legend_text);
%xlim([0 xmax ]);
%ylim([0 xmax]);
