function [ ] = fig_n_stems_tree_neon( site_all, plot_all, n_stems_all )
...
filename = sprintf('%s%s', path_latex,'n_stems_tree_neon.tex');
...
for i = 1:n_site_all;
    xmax(i,1) = max([n_stems_all{i}.NEON_all n_stems_all{i}.TREE_all]);
    legend_text{i} = sprintf('Site %02.0f',site_all(i));
    plot(n_stems_all{i}.NEON_all,n_stems_all{i}.TREE_all,'x','markersize',10,'linewidth',2,'markeredgecolor',color(i,:));
end

%{
for i = 1:n_site_all;
    xmax(i,2) = max([n_stems_all{i}.NEON_over n_stems_all{i}.SEG_over]);
    xmax(i,3) = max([n_stems_all{i}.NEON_under n_stems_all{i}.SEG_under]);
    plot(n_stems_all{i}.NEON_over,n_stems_all{i}.SEG_over,'o','markersize',10,'linewidth',2,'markeredgecolor',color(i,:));
    plot(n_stems_all{i}.NEON_under,n_stems_all{i}.SEG_under,'+','markersize',10,'linewidth',2,'markeredgecolor',color(i,:));
end 
%}
