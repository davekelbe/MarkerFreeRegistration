function [ ] = fig_ba_tree_neon( site_all, plot_all, ba_all )
...
legend_str{5} = sprintf('RMSE = %3.2f m^2 ha^{-1}',25*s);
...
path_latex = 'Z:\Desktop\Paper\';filename = sprintf('%s%s', path_latex,'ba_tree_neon.tex');
