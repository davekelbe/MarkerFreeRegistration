function [  ] = lidar_JVA(info_site, info_plot, info_terminate, info_exp, info_suffix, path_up, options_skipseg )
...
% Make directories
%path_up = '/Volumes/Asterix/Processed/';
path_common = sprintf('%s%s%s%s%s',path_up,...
    info_exp, info_slash, 'Common',info_slash);
%path_top = sprintf('%s%s%s%s%s%03.0f%s%03.0f%s','~/Documents/',...
...
path_latex = '~/Desktop/Paper/results/';
...
% check if output already exists, then return
filepath_seg_row = sprintf('%s%s%s',path_mat,'seg_row','.mat');
if exist(filepath_seg_row);
    return
end
...
switch info_exp
    case 'TEST2'
        ...
        options_las_processor = 'old';    
    case 'TEST'
        path_source = '/Volumes/DJK/Asterix/Renamed/TEST-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'old';
    case 'KIP3'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP3-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'KIP6'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP6-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'KIP9'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP9-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'KIP13'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP13-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'KIP18'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP18-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'KIP30'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/KIP30-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'HAKT1'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/HAKT1-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'HAKT2'
        path_source = '/Volumes/DJK/Asterix/Renamed/BIRD/HAKT1-lidar/';
        ...
        options_las_processor = 'new';
    case 'HAVO'
        path_source = '/Volumes/DJK/Asterix/Renamed/HAVO-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'MAT'
        path_source = '/Volumes/DJK/Asterix/Renamed/MAT-lidar/';
        filename_source = sprintf('%s-%03.0f-%03.0f', info_exp, info_site, info_plot);
        options_las_processor = 'new';
    case 'harvard'
        ...
        options_las_processor = 'old';
    case 'soaproot'
        path_source = 'D:\Data\CaliforniaLidar\';
